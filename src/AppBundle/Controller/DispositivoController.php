...
use AppBundle\Form\DispositivoType;
...
class DispositivoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $dispositivos = $em->getRepository('AppBundle:Dispositivo')->findAll();

        return $this->render('dispositivo/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\DispositivoType', $dispositivo);
    ...
    public function showAction(Dispositivo $dispositivo)
    {
        ...
        return $this->render('dispositivo/show.html.twig', array(
            'dispositivo' => $dispositivo,
    ...
    {
        $deleteForm = $this->createDeleteForm($dispositivo);
        $editForm = $this->createForm('AppBundle\Form\DispositivoType', $dispositivo);
